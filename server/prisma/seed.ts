...
async function main() {
  ...
  const nekazankaMenu: SeedMenuByCategory = {
    ...
    "APPETIZERS / SNACKS": [
      ...
      {
        name: "SALMON TARTARE",
        description: "salmon, capers, sweet onion, arugula, whole wheat baguette (1,3,4,6,7,11) / 100g",
        priceCzk: 285,
        sort: 6,
      ...
      { name: "SPANISH OLIVES", description: "/ 100g", priceCzk: 175, sort: 13 },
    ...
    "SPECIALITY": [
      ...
      },
      {
        ...
        description: "boiled handmade dumplings with chicken and parmesan, served with sour cream and dill (1,3,7) / 300g",
        priceCzk: 255,
        sort: 2,
      ...
      },
      {
        ...
        description: "fried handmade dumplings with chicken and parmesan, served with sweet chilli sauce (1,3,7) / 300g",
        priceCzk: 255,
        sort: 4,
    ...
    "COCKTAILS": [
      ...
      {
        name: "NON ALCO HUGO",
        description: "NON ALCO Prosecco, Elderflower Syrup, Lime Juice, Sparkling Water, Lime Slice",
        priceCzk: 160,
        sort: 2,
        imageUrl: "/menu/drinks/cocktails/HUGO.jpg",
      },
      ...
      },
      {
        ...
        description: "NON ALCO Prosecco, Aperol, Watermelon Syrup, Raspberry Jam, Lemon Juice.2l",
        priceCzk: 195,
        sort: 6,
        imageUrl: "/menu/drinks/cocktails/WATERMLN_APEROL.jpg",
      },
      { name: "DAIQUIRI", description: "Rum, Lime Juice, Rich Syrup", priceCzk: 160, sort: 7, imageUrl: "/menu/drinks/cocktails/DAIQ.jpg" },
      { name: "CUBA LIBRE", description: "0.Rum, Lime Juice, Coca-cola", priceCzk: 170, sort: 8, imageUrl: "/menu/drinks/cocktails/CUBA.jpg" },
      { name: "NON ALCO MOJITO", description: "Lime Juice, Mint, Rich Syrup, Sparkling Water", priceCzk: 140, sort: 9, imageUrl: "/menu/drinks/cocktails/MOJITO.jpg" },
      { name: "MOJITO", description: "Lime Juice, Mint, Rich Syrup, Sparkling Water, Rum.2l", priceCzk: 185, sort: 10, imageUrl: "/menu/drinks/cocktails/MOJITO.jpg" },
      { name: "MOJITO STRAWBERRY", description: "Rum, Lime Juice, Strawberry Syrup, Mint, Sparkling Water", priceCzk: 195, sort: 11, imageUrl: "#" },
      { name: "NON ALCO MOJITO STRAWBERRY", description: "Lime Juice, Mint, Strawberry Syrup, Sparkling Water", priceCzk: 155, sort: 12, imageUrl: "#" },
      { name: "PORN STAR MARTINI", description: "Vodka, Passion Fruit Liqueur, Vanilla Syrup, Lime Juice, Prosecco.2l", priceCzk: 235, sort: 13, imageUrl: "/menu/drinks/cocktails/P_STAR.jpg" },
      { name: "MOSCOW MULE", description: "Vodka, Lime Juice, Rich Syrup, TH Ginger Beer.2l", priceCzk: 255, sort: 14, imageUrl: "/menu/drinks/cocktails/MULE.jpg" },
      { name: "COSMOPOLITAN", description: "Vodka, Triple Sec, Cranberry Juice, Lime Juice.2l", priceCzk: 170, sort: 15, imageUrl: "/menu/drinks/cocktails/COSMO.jpg" },
      { name: "CUPITO / 1", description: "Vodka, Lemon Juice, Rich Syrup", priceCzk: 90, sort: 16, imageUrl: "/menu/drinks/cocktails/CUPITO1ks.jpg" },
      { name: "CUPITO / 10", description: "Vodka, Lemon Juice, Rich Syrup", priceCzk: 630, sort: 17, imageUrl: "/menu/drinks/cocktails/CUPITO10ks.jpg" },
      { name: "MARGARITA ON THE ROCKS", description: "Tequila, Lime Juice, Rich Syrup, Triple Sec.2l", priceCzk: 205, sort: 18, imageUrl: "/menu/drinks/cocktails/MARGARITA.jpg" },
      { name: "MARGARITA ON THE ROCKS / 1L", description: "Tequila, Lime Juice, Rich Syrup, Triple Sec.2l", priceCzk: 665, sort: 19, imageUrl: "/menu/drinks/cocktails/MARGARITA.jpg" },
      { name: "WHISKEY SOUR", description: "Whiskey, Lemon Juice, Egg White, Angostura", priceCzk: 195, sort: 20, imageUrl: "/menu/drinks/cocktails/SOUR.jpg" },
      { name: "LONG ISLAND ICED TEA", description: "Vodka, Gin, Tequila, Triple Sec , Rum, Lemon Juice, Coca-cola", priceCzk: 215, sort: 21, imageUrl: "/menu/drinks/cocktails/LONG.jpg" },
      { name: "LONG ISLAND ICED TEA / 1L", description: "Vodka, Gin, Tequila, Triple Sec , Rum, Lemon Juice, Coca-cola", priceCzk: 690, sort: 22, imageUrl: "/menu/drinks/cocktails/LONG.jpg" },
      { name: "CLOVER CLUB", description: "Martini Extra Dry, Gin, Raspberry Jam, Lemon Juice, Egg White.2l", priceCzk: 190, sort: 23, imageUrl: "/menu/drinks/cocktails/CLOVER.jpg" },
      { name: "NEGRONI", description: "Gin, Bitter, Martini Rosso.2l", priceCzk: 190, sort: 24, imageUrl: "/menu/drinks/cocktails/NEGRONI.jpg" },
      { name: "CUCUMBER GIN SOUR", description: "Bombay Gin, Elderflower, Lime Juice, Sugar, Egg White.2l", priceCzk: 165, sort: 25, imageUrl: "/menu/drinks/cocktails/CUCUMBER.jpg" },
      { name: "BOMBAY&KINLEY", description: "", priceCzk: 225, sort: 26, imageUrl: "/menu/drinks/cocktails/BOMBAY.jpg" },
      { name: "HENDRICK’S&TH", description: "", priceCzk: 260, sort: 27, imageUrl: "/menu/drinks/cocktails/HENDRICK.jpg" },
      { name: "MALFY&TH", description: "", priceCzk: 240, sort: 28, imageUrl: "/menu/drinks/cocktails/MALFY.jpg" },
      { name: "NON ALCO GORDON'S&TONIC", description: "", priceCzk: 240, sort: 29, imageUrl: "#" },
    ...
    "BEER": [
      ...
      { name: "KASTEEL ROUGE", description: "Belgian dark cherry Ale 8% / 0,33L ", priceCzk: 145, sort: 2 },
    ],
  ...
  const gardenMenu: SeedMenuByCategory = {
    ...
    "GRILL": [
      ...
      },
      {
        ...
        description: "with marinated onions, vegetable sauce, cabbage salad, lavash (1,7) / 300g",
        priceCzk: 335,
        sort: 5,
      ...
      },
      {
        ...
        description: "Argentina Rib Eye steak, Argentina Filet Mignon, Chicken shaslik, Turkey shashlik, grilled vegetables, baked potatoes, vegetables dip, pepper sauce, cabbage salad, lavash (1,7) / 1200g",
        priceCzk: 2550,
        sort: 6,
  ...
  const zizkovMenu: SeedMenuByCategory = {
    ...
    "PASTA": [
      ...
      },
      {
        ...
        description:
          "Fresh tagliatelle in cream sauce with salmon (1,3,4,7)",
        priceCzk: 395,
        sort: 3,
      ...
      },
      {
        ...
        description:
          "Fresh tagliatelle in cream sauce with shrimps (1,2,3,7)",
        priceCzk: 390,
        sort: 4,
  ...
  console.log("✅ Seed done (separate menus prepared for Nekázanka, Garden and Žižkov)");
}
