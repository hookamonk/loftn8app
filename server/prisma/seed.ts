import { type MenuSection, PrismaClient } from "@prisma/client";
import { applyMenuTranslations } from "./applyMenuTranslations";
...
type SeedMenuByCategory = Record<string, SeedItem[]>;
...
async function ensureVenueMenuCategories(venueId: number) {
	...
	for (const category of defaultMenuCategoryDefinitions()) {
		const upserted = await upsertCategory(
			venueId,
			category.name,
			category.sort,
			category.section,
...
function assertNoDuplicateSeedItems(
	venueSlug: string,
...
async function seedVenueMenuItems(
	...
	const categoryIds = Array.from(
		new Set(Array.from(cats.values()).map((cat) => cat.id)),
	);
...
async function main() {
	...
	for (const legacyName of ["SPIRITS", "WINE", "HOT DRINKS"] as const) {
		...
		const cnt = await prisma.menuItem.count({
	...
	const legacyBar = await prisma.menuCategory.findFirst({
		where: { venueId: venue.id, name: "Bar" },
	});
	...
	// ===== 4) MENU ITEMS =====
	// ============================================================================
	// NEKAZANKA MENU START
	// Edit Nekázanka menu here
	// ============================================================================
	const nekazankaMenu: SeedMenuByCategory = {
		// ============ DISHES ============
		"APPETIZERS / SNACKS": [
			{
			...
			},
			{
				name: "CHEESE PLATTER",
				description:
					"4 types of cheese, honey, fig jam, apples, crackers (1,3,7)",
				priceCzk: 310,
				sort: 9,
			...
			},
			{
				...
				description:
					"Pancakes, red caviar, dill, mayo dip (1,3,4,7,10) / 4 pcs",
				priceCzk: 225,
				sort: 10,
			...
			{ name: "PISTACHIO", description: "(8) / 60g", priceCzk: 95, sort: 14 },
		],
		...
		"SALADS / SOUPS": [
			...
			},
			{
				...
				description:
					"baked vegetables, champions, olive oil, balsamico, microgreens (6) / 250g",
				priceCzk: 115,
				sort: 2,
			},
			{
				...
				description:
					"kumato tomatoes, cucumber, red onions, dill, cilantro, olive oil / 200g",
				priceCzk: 125,
				sort: 3,
			...
			},
			{
				...
				description:
					"multilayer salad with salmon, vegetables and egg (3,4,5,7,10) / 400g",
				priceCzk: 295,
				sort: 5,
			...
			},
			{
				...
				description:
					"multilayer salad with salmon, vegetables and egg (3,4,5,7,10) / 200g",
				priceCzk: 175,
				sort: 6,
			...
			},
			{
				name: "TOM YAM KUNG",
				description:
					"shrimps, salmon, champignons, cilantro coconut milk, rice (2,4,11) / 0,45l",
				priceCzk: 225,
				sort: 11,
		...
		"FISH / MEAT": [
			...
			},
			{
				...
				description:
					"recommended side dish: grilled vegetables or mashed potatoes (4,7) / 200g",
				priceCzk: 385,
				sort: 2,
				imageUrl: "/menu/dishes/meat/GRILLED_SALMON_STEAK.jpg",
			},
			{
				name: "GRILLED CHICKEN STEAK (sauce not included)",
				description:
					"recommended: cream sauce with mushrooms and onion (7) / 200g",
				priceCzk: 235,
				sort: 3,
			...
			},
			{
				...
				description:
					"beef from farm Maso z pastvin, egg, microgreen (3,6,7) / 150g",
				priceCzk: 265,
				sort: 4,
		...
		SUSHI: [
			...
			},
			{
				name: "KOREAN KIMBAP",
				description:
					"Argentina aged filet, marinated carrot, cucumber, teriyaki, sesame (6,11) / 8 pcs",
				priceCzk: 325,
				sort: 4,
			...
			},
			{
				...
				description:
					"marinated carrot, cucumber, pepper, teriyaki, sesame (6,11) / 8 pcs",
				priceCzk: 155,
				sort: 5,
			...
			},
			{
				...
				description:
					"chicken, Philadelphia, cucumber, unagi, sesame (1,3,4,6,7,11) / 8 pcs",
				priceCzk: 275,
				sort: 7,
			...
			{
				name: "SUSHI MENU 1",
				description: "ura maki, tom yam kung",
				priceCzk: 345,
				sort: 10,
			},
			{
				name: "SUSHI MENU 2",
				description: "fusion roll, tom yam kung",
				priceCzk: 375,
				sort: 11,
			},
			{
				name: "SUSHI SET",
				description: "2x fusion roll, 2x ura maki",
				priceCzk: 995,
				sort: 12,
			},
		],
		...
		SPECIALITY: [
			{
				...
				description:
					"boiled handmade dumplings with beef, served with sour cream and chives (1,3,7) / 300g",
				priceCzk: 275,
				sort: 1,
			...
			},
			{
				...
				description:
					"fried handmade dumplings with beef, served with sweet chilli sauce (1,3,7) / 300g",
				priceCzk: 275,
				sort: 3,
			...
			},
			{
				...
				description:
					"boiled handmade dumplings with potato and onions, served with sour cream (1,3,7) / 300g",
				priceCzk: 215,
				sort: 5,
			...
			},
			{
				...
				description:
					"fried handmade dumplings with potato and onions, served with sweet chilli sauce (1,3,7) / 300g",
				priceCzk: 215,
				sort: 6,
			...
			},
			{
				name: "HANDMADE SAMSA",
				description:
					"puff pastry with beef and lamb meat, onion, adjika (1,3,7,11)",
				priceCzk: 275,
				sort: 7,
		...
		"SIDE DISHES / SAUCES": [
			{
				...
				description:
					"freshly baked wholewheat bread with herb butter and olive oil dip with vegetables / 100g",
				priceCzk: 65,
				sort: 1,
			...
			},
			{
				...
				priceCzk: 85,
				sort: 2,
				imageUrl: "/menu/dishes/side/BUCKWHEAT.jpg",
			},
			{
				name: "BAKED POTATOES",
				description: "200g",
			...
			},
			{
				...
				priceCzk: 65,
				sort: 6,
				imageUrl: "/menu/dishes/side/RICE.jpg",
			},
			{
		...
		DESSERTS: [
			{
				...
				description:
					"pancakes, cottage cheese, sour cream, vanila sugar (1,3,7) / 2 pcs",
				priceCzk: 135,
				sort: 1,
			...
			},
			{
				name: "SYRNIKI",
				description:
					"cottage pancakes, strawberry jam, sour cream, chocolate topping (1,3,7) / 5 pcs",
				priceCzk: 195,
				sort: 2,
			...
			},
			{
				...
				description:
					"Our delicious crispy rolls with condensed milk and Philadelphia cheese. (1,3,7) / 1 pcs",
				priceCzk: 85,
				sort: 3,
			...
			},
			{
				...
				description:
					"Homemade shortbread cookies with condensed milk and walnuts. (1,3,7,8) / 1 pcs",
				priceCzk: 25,
				sort: 4,
				imageUrl: "/menu/dishes/desserts/SHORTBREAD.jpg",
			},
		],
		...
		COCKTAILS: [
			{
				name: "HUGO",
				description:
					"Prosecco, Elderflower Syrup, Lime Juice, Sparkling Water, Lime Slice",
				priceCzk: 160,
				sort: 1,
			...
			},
			{
				name: "NON ALCO HUGO",
				description:
					"NON ALCO Prosecco, Elderflower Syrup, Lime Juice, Sparkling Water, Lime Slice",
				priceCzk: 160,
				sort: 2,
				imageUrl: "/menu/drinks/cocktails/HUGO.jpg",
			},
			{
				name: "HUGO / 1L",
				description:
					"Prosecco, Elderflower Syrup, Lime Juice, Sparkling Water, Lime Slice.2l",
				priceCzk: 510,
				sort: 3,
				imageUrl: "/menu/drinks/cocktails/HUGO.jpg",
			},
			...
			{
				name: "NON ALCO APEROL",
				description: "NON ALCO Prosecco, Sparkling Water, Aperol, Orange",
				priceCzk: 170,
				sort: 5,
				imageUrl: "/menu/drinks/cocktails/APEROL.jpg",
			},
			...
			},
			{
				...
				description:
					"Prosecco, Aperol, Watermelon Syrup, Raspberry Jam, Lemon Juice.2l",
				priceCzk: 195,
				sort: 5,
				imageUrl: "/menu/drinks/cocktails/WATERMLN_APEROL.jpg",
			},
			{
				name: "NON ALCO WATERMELON APEROL",
				description:
					"NON ALCO Prosecco, Aperol, Watermelon Syrup, Raspberry Jam, Lemon Juice.2l",
				priceCzk: 195,
				sort: 6,
				imageUrl: "/menu/drinks/cocktails/WATERMLN_APEROL.jpg",
			},
			{
				name: "DAIQUIRI",
				description: "Rum, Lime Juice, Rich Syrup",
				priceCzk: 160,
				sort: 7,
				imageUrl: "/menu/drinks/cocktails/DAIQ.jpg",
			},
			{
				name: "CUBA LIBRE",
				description: "0.Rum, Lime Juice, Coca-cola",
				priceCzk: 170,
				sort: 8,
				imageUrl: "/menu/drinks/cocktails/CUBA.jpg",
			},
			{
				name: "NON ALCO MOJITO",
				description: "Lime Juice, Mint, Rich Syrup, Sparkling Water",
				priceCzk: 140,
				sort: 9,
				imageUrl: "/menu/drinks/cocktails/MOJITO.jpg",
			},
			{
				name: "MOJITO",
				description: "Lime Juice, Mint, Rich Syrup, Sparkling Water, Rum.2l",
				priceCzk: 185,
				sort: 10,
				imageUrl: "/menu/drinks/cocktails/MOJITO.jpg",
			},
			{
				...
				description: "Rum, Lime Juice, Strawberry Syrup, Mint, Sparkling Water",
				priceCzk: 195,
				sort: 11,
				imageUrl: "#",
			},
			{
				name: "NON ALCO MOJITO STRAWBERRY",
				description: "Lime Juice, Mint, Strawberry Syrup, Sparkling Water",
				priceCzk: 155,
				sort: 12,
				imageUrl: "#",
			},
			{
				...
				description:
					"Vodka, Passion Fruit Liqueur, Vanilla Syrup, Lime Juice, Prosecco.2l",
				priceCzk: 235,
				sort: 13,
				imageUrl: "/menu/drinks/cocktails/P_STAR.jpg",
			},
			{
				name: "MOSCOW MULE",
				description: "Vodka, Lime Juice, Rich Syrup, TH Ginger Beer.2l",
				priceCzk: 255,
				sort: 14,
				imageUrl: "/menu/drinks/cocktails/MULE.jpg",
			},
			{
				name: "COSMOPOLITAN",
				description: "Vodka, Triple Sec, Cranberry Juice, Lime Juice.2l",
				priceCzk: 170,
				sort: 15,
				imageUrl: "/menu/drinks/cocktails/COSMO.jpg",
			},
			{
				name: "CUPITO / 1",
				description: "Vodka, Lemon Juice, Rich Syrup",
				priceCzk: 90,
				sort: 16,
				imageUrl: "/menu/drinks/cocktails/CUPITO1ks.jpg",
			},
			{
				name: "CUPITO / 10",
				description: "Vodka, Lemon Juice, Rich Syrup",
				priceCzk: 630,
				sort: 17,
				imageUrl: "/menu/drinks/cocktails/CUPITO10ks.jpg",
			},
			{
				name: "MARGARITA ON THE ROCKS",
				description: "Tequila, Lime Juice, Rich Syrup, Triple Sec.2l",
				priceCzk: 205,
				sort: 18,
				imageUrl: "/menu/drinks/cocktails/MARGARITA.jpg",
			},
			{
				name: "MARGARITA ON THE ROCKS / 1L",
				description: "Tequila, Lime Juice, Rich Syrup, Triple Sec.2l",
				priceCzk: 665,
				sort: 19,
				imageUrl: "/menu/drinks/cocktails/MARGARITA.jpg",
			...
			{
				name: "WHISKEY SOUR",
				description: "Whiskey, Lemon Juice, Egg White, Angostura",
				priceCzk: 195,
				sort: 20,
				imageUrl: "/menu/drinks/cocktails/SOUR.jpg",
			},
			{
				name: "LONG ISLAND ICED TEA",
				description:
					"Vodka, Gin, Tequila, Triple Sec , Rum, Lemon Juice, Coca-cola",
				priceCzk: 215,
				sort: 21,
				imageUrl: "/menu/drinks/cocktails/LONG.jpg",
			},
			{
				name: "LONG ISLAND ICED TEA / 1L",
				description:
					"Vodka, Gin, Tequila, Triple Sec , Rum, Lemon Juice, Coca-cola",
				priceCzk: 690,
				sort: 22,
			...
			},
			{
				name: "CLOVER CLUB",
				description:
					"Martini Extra Dry, Gin, Raspberry Jam, Lemon Juice, Egg White.2l",
				priceCzk: 190,
				sort: 23,
				imageUrl: "/menu/drinks/cocktails/CLOVER.jpg",
			},
			{
				name: "NEGRONI",
				description: "Gin, Bitter, Martini Rosso.2l",
				priceCzk: 190,
				sort: 24,
				imageUrl: "/menu/drinks/cocktails/NEGRONI.jpg",
			},
			{
				name: "CUCUMBER GIN SOUR",
				description: "Bombay Gin, Elderflower, Lime Juice, Sugar, Egg White.2l",
				priceCzk: 165,
				sort: 25,
				imageUrl: "/menu/drinks/cocktails/CUCUMBER.jpg",
			},
			{
				name: "BOMBAY&KINLEY",
				description: "",
				priceCzk: 225,
				sort: 26,
				imageUrl: "/menu/drinks/cocktails/BOMBAY.jpg",
			},
			{
				name: "HENDRICK’S&TH",
				description: "",
				priceCzk: 260,
				sort: 27,
				imageUrl: "/menu/drinks/cocktails/HENDRICK.jpg",
			},
			{
				name: "MALFY&TH",
				description: "",
				priceCzk: 240,
				sort: 28,
				imageUrl: "/menu/drinks/cocktails/MALFY.jpg",
			},
			{
				name: "NON ALCO GORDON'S&TONIC",
				description: "",
				priceCzk: 240,
				sort: 29,
				imageUrl: "#",
		...
		BEER: [
			{ name: "BIRELL", description: "0,33L", priceCzk: 60, sort: 1 },
			{
				name: "KASTEEL ROUGE",
				description: "Belgian dark cherry Ale 8% / 0,33L ",
				priceCzk: 145,
				sort: 2,
			},
		],
		...
		"WINE · Red": [
			{
				name: "MULLED WINE KINDZMARAULI MARANI 2021",
				description: "Semi-sweet / 0,2L",
				priceCzk: 255,
				sort: 1,
			},
			{
				name: "KINDZMARAULI MARANI 2021",
				description: "Semi-sweet / 0,1L",
				priceCzk: 155,
				sort: 2,
			},
			{
				name: "KINDZMARAULI MARANI 2021",
				description: "Semi-sweet / 0,75L",
				priceCzk: 930,
				sort: 3,
			},
			{
				name: "PRIMITIVO PUGLIA IGT",
				description: "Dry / 0,1L",
				priceCzk: 135,
				sort: 4,
			},
			{
				name: "PRIMITIVO PUGLIA IGT",
				description: "Dry / 0,75L",
				priceCzk: 790,
				sort: 5,
			},
			{
				name: "BOURGOGNE PINOT NOIR 2022 VIEILLES VIGNES PHILIPPE LE HARDI",
				description: "Dry / 0,75L",
				priceCzk: 1490,
				sort: 6,
			},
			{
				name: "HOT WINE",
				description:
					"Kindzmarauli based hot, spiced, sweetened red wine / 0,2L",
				priceCzk: 255,
				sort: 7,
			},
		],
		"WINE · Rosé": [
			{
				name: "CÔTES DE PROVENCE 2022 CHATEAU MINUTY M ROSÉ",
				description: "Dry / 0,75L",
				priceCzk: 1290,
				sort: 1,
			},
		...
		"WINE · White": [
			...
			{
				name: "DOMAINE DE MISELLE CHARDONNAY",
				description: "Dry / 0,1L",
				priceCzk: 145,
				sort: 5,
			},
			...
			{
				name: "CHABLIS 2023 JEAN-MARC BROCARD",
				description: "Dry / 0,75L",
				priceCzk: 1490,
				sort: 7,
			},
		...
		"WINE · Sparkling": [
			{
				name: "PROSECCO COLLIO BLU D.O.C. MILLESIMATO",
				description: "Extra Dry, Venetto (Italy) / 0,1L",
				priceCzk: 125,
				sort: 1,
			},
			{
				name: "PROSECCO COLLIO BLU D.O.C. MILLESIMATO",
				description: "Extra dry, Veneto (Italy) / 0,75L",
				priceCzk: 790,
				sort: 2,
			},
			{
				name: "PROSECCO ASOLO D.O.C.G EXTRA DRY SUPERIORE MILLESIMATO",
				description: "Extra Dry, Veneto (Italy) / 0,75L",
				priceCzk: 890,
				sort: 3,
			},
			{
				name: "PROSECCO VALDOBBIADENE BRUT D.O.C.G. SUPERIORE",
				description: "Combai, Veneto, Italy / 0,75L",
				priceCzk: 990,
				sort: 4,
			},
			{
				name: "CHANDON GARDEN SPRITZ",
				description: "Bittersweet / 0,75L",
				priceCzk: 830,
				sort: 5,
			},
			{
				name: "MOSCATO CAJO SPUMANTE DOLCE",
				description: "Sweet / 0,75L",
				priceCzk: 890,
				sort: 6,
			},
			{
				name: "ASTI MARTINI D.O.C.G",
				description: "Sweet / 0,75L",
				priceCzk: 990,
				sort: 7,
			},
			{
				name: "CREMANT DE BORDEAUX MISSION SAINT VINCENT BRUT",
				description: "Dry / 0,75L",
				priceCzk: 1090,
				sort: 8,
			},
			...
			{
				name: "LOUIS RODERER BRUT CRISTAL 2016",
				description: "Dry / 0,75L",
				priceCzk: 14900,
				sort: 14,
			},
		...
		"SOFT DRINKS": [
			{
				name: "CARAFE OF STILL WATER WITH LEMON AND MINT",
				description: "KARAFA VODY / 1L",
				priceCzk: 60,
				sort: 1,
			},
			{
				name: "CARAFE OF SPARKLING WATER",
				description: "KARAFA PERLIVÉ VODY / 1L",
				priceCzk: 95,
				sort: 2,
			},
		...
		"HOT DRINKS · Tea": [
			...
			{
				name: "JASMIN TEA",
				description: "JASMÍNOVÝ ČAJ",
				priceCzk: 130,
				sort: 3,
			},
			{
				name: "MOROCCAN MINT TEA",
				description: "MAROCKÁ MÁTA",
				priceCzk: 130,
				sort: 4,
			},
			{
				name: "FRESH MINT TEA",
				description: "ČAJ Z ČERSTVÉ MÁTY",
				priceCzk: 115,
				sort: 5,
			},
			{
				name: "FRESH GINGER TEA",
				description: "ČAJ Z ČERSTVÉHO ZÁZVORU",
				priceCzk: 115,
				sort: 6,
			},
		...
		// ============ HOOKAH ============
		"CLASSIC HOOKAH": [
			{ name: "BLONDE LEAF", description: "", priceCzk: 490, sort: 1 },
			{ name: "DARK LEAF", description: "", priceCzk: 560, sort: 2 },
			{ name: "BOWL REPLACEMENT", description: "", priceCzk: 390, sort: 3 },
			{ name: "EXPRESS BLONDE LEAF", description: "", priceCzk: 390, sort: 4 },
			{ name: "EXPRESS DARK LEAF", description: "", priceCzk: 460, sort: 5 },
		],
		...
		EXTRA: [
			{ name: "RENTAL 1H", description: "", priceCzk: 300, sort: 1 },
			{ name: "BROKEN VASE NEBULLA", priceCzk: 2500, sort: 2 },
		],
	};

	const gardenMenu: SeedMenuByCategory = {
		// ============ DISHES ============
		"APPETIZERS / SNACKS": [
			{
				name: "KOREAN CARROT SALAD",
		...
		GRILL: [
			{
				name: "ARGENTINA RIB EYE STEAK",
				description: "Argentina aged rib eye (7) / 100g",
				priceCzk: 285,
				sort: 1,
				imageUrl: "/menu/dishes/grill/ARGENTINA_STEAK.jpg",
			},
			{
				name: "ARGENTINA FILET",
				description: "Argentina aged filet (7) / 220g",
				priceCzk: 385,
				sort: 2,
				imageUrl: "/menu/dishes/grill/FILET.jpg",
			},
			{
				name: "GRILLED CHICKEN STEAK (sauce not included)",
				description:
			...
			{
				name: "GRILLED SALMON STEAK WITH HERB BUTTER",
				description: "recommended: sweet potato or rice (4,7) / 200g",
				priceCzk: 385,
				sort: 4,
				imageUrl: "/menu/dishes/grill/SALMON_STEAK.jpg",
			},
			{
				name: "CHICKEN SHASHLIK",
				description:
					"with marinated onions, vegetable sauce, cabbage salad, lavash (1,7) / 300g",
				priceCzk: 335,
				sort: 5,
				imageUrl: "/menu/dishes/grill/CHICKEN_SHASHLIK.jpg",
			},
			{
				name: "TURKEY SHASHLIK",
				description:
					"with marinated onions, vegetable sauce, cabbage salad, lavash (1,7) / 300g",
				priceCzk: 355,
				sort: 5,
				imageUrl: "/menu/dishes/grill/TURKEY_SHASHLIK.jpg",
			},
			{
				name: "MIX GRILL PRE-ORDER",
				description:
					"Argentina Rib Eye steak, Argentina Filet Mignon, Chicken shaslik, Turkey shashlik, grilled vegetables, baked potatoes, vegetables dip, pepper sauce, cabbage salad, lavash (1,7) / 1200g",
				priceCzk: 2550,
				sort: 6,
				imageUrl: "/menu/dishes/grill/MIX_GRILL.jpg",
			},
		],
	...
	const zizkovMenu: SeedMenuByCategory = {
		// ============ DISHES ============
		"APPETIZERS / SNACKS": [
			{
				name: "KOREAN CARROT SALAD",
		...
		PASTA: [
			{
				name: "TAGLIATELLE IN CREAM SAUCE",
				description:
					"Fresh tagliatlle in cream sauce with mushrooms and onion (1,3,7)",
				priceCzk: 175,
				sort: 1,
				imageUrl: "/menu/dishes/pasta/TAGLIATELLE_CREAM.jpg",
			},
			{
				name: "TAGLIATELLE CON POLLO IN CREAM SAUCE",
				description:
					"Fresh tagliatelle in cream sauce with chicken, mushrooms and onion (1,3,7)",
				priceCzk: 340,
				sort: 2,
				imageUrl: "/menu/dishes/pasta/TAGLIATELLE_CREAM.jpg",
			},
			{
				name: "TAGLIATELLE IN CREAM SAUCE WITH SALMON",
				description: "Fresh tagliatelle in cream sauce with salmon (1,3,4,7)",
				priceCzk: 395,
				sort: 3,
				imageUrl: "/menu/dishes/pasta/TAGLIATELLE_SALMON.jpg",
			},
			{
				name: "TAGLIATELLE IN CREAM SAUCE WITH SHRIMPS",
				description: "Fresh tagliatelle in cream sauce with shrimps (1,2,3,7)",
				priceCzk: 390,
				sort: 4,
				imageUrl: "/menu/dishes/pasta/TAGLIATELLE_SHRIMPS.jpg",
			},
		],
		...
		COCKTAILS: [
			...
			},
			{
				name: "MOJITO STRAWBERRY",
				description:
					"0.Rum, Lime Juice, Strawberry Syrup, Mint, Sparkling Water",
				priceCzk: 195,
				sort: 10,
				imageUrl: "#",
			},
			{
				name: "MOJITO STRAWBERRY (non-alco)",
				description: "0.Lime Juice, Mint, Strawberry Syrup, Sparkling Water",
				priceCzk: 155,
				sort: 11,
				imageUrl: "#",
			},
	...
	const menuByVenueSlug: Record<string, SeedMenuByCategory> = {
		nekazanka: nekazankaMenu,
		garden: gardenMenu,
		zizkov: zizkovMenu,
	};
	...
	assertNoDuplicateSeedItems(
		venue.slug,
		menuByVenueSlug[venue.slug] ?? nekazankaMenu,
	);
	...
	await seedVenueStaff(
		venue.id,
		baseVenueDef.staffPrefix,
		baseVenueDef.defaults,
		baseVenueDef.legacyPrefix,
	);

	for (const target of VENUES.filter(
		(candidate) => candidate.slug !== baseVenueDef.slug,
	)) {
	...
	console.log(
		"✅ Seed done (separate menus prepared for Nekázanka, Garden and Žižkov)",
	);
}
