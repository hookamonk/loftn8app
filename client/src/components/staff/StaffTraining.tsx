...
const SLIDES: Slide[] = [
  {
    ...
    intro:
      "Здесь вы видите всё, что происходит в зале прямо сейчас. Внизу — вкладки разделов.",
    points: [
      "«Сводка» — смена, уведомления и быстрые цифры.",
      "«Заказы», «Вызовы», «Оплаты» — то, что просят гости.",
  ...
  },
  {
    title: "Заказы",
    intro:
      "Гость выбирает блюда в меню — у вас появляется «Запрос на заказ» по столу.",
    points: [
      "«Подтвердить» — создаёт заказ сразу из того, что выбрал гость.",
      "«Дополнить» — открывает форму, чтобы добавить позиции или собрать заказ вручную.",
      "Когда блюдо готово — нажмите «Отметить готовым».",
    ],
    examples: [
